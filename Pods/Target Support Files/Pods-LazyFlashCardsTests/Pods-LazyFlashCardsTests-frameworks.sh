...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-LazyFlashCardsTests/BRYSerialAnimationQueue.framework"
  ...
  install_framework "Pods-LazyFlashCardsTests/PopupDialog.framework"
  install_framework "Pods-LazyFlashCardsTests/PureLayout.framework"
  install_framework "Pods-LazyFlashCardsTests/SSBouncyButton.framework"
  ...
  install_framework "Pods-LazyFlashCardsTests/UIColor_Hex.framework"
  install_framework "Pods-LazyFlashCardsTests/UIImage_BetterAdditions.framework"
fi
