...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods/BRYSerialAnimationQueue.framework"
  ...
  install_framework "Pods/SSBouncyButton.framework"
  ...
  install_framework "Pods/UIImage_BetterAdditions.framework"
fi
